...
# be safe about adding new extensions
try:
    import sphinxcontrib.bibtex
    extensions.append('sphinxcontrib.bibtex')
except ImportError:
    print('WARNING: sphinxcontrib.bibtex extension not found => can not generate references for documentation !')
else:
    # bibtex dirac custom style
...
project = u'DIRAC'
copyright = u'The authors of DIRAC'
...
try:
  dirac_version = open(os.path.join('..', '..', 'VERSION'), 'r').read().rstrip()
except:
  dirac_version = 'not found'
# The short X.Y version.
version = dirac_version
# The full version, including alpha/beta/rc tags.
release = dirac_version
...
# for source files.
exclude_trees = ['_build','workshop-slides']
...
try:
    ...
    html_context = {
        # custom theme css file, put your styles here
        'css_files': ['_static/theme-custom.css'],
    }
except ImportError:
    print('sphinx_rtd_theme extension not found - fallback to the old theme')
    html_theme = 'dirac'
...
latex_documents = [
  ('index', 'dirac_manual.tex', u'DIRAC Documentation',
   u'DIRAC authors', 'manual'),
]
