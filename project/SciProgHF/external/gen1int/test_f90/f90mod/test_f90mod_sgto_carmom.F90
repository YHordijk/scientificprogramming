...
!!
!!  Tests tests Cartesian multipole integrals from Fortran 90 modules using SGTOs.
!!
!!  2012-03-20, Bin Gao
!!  * first version

  !> \brief tests Cartesian multipole integrals from Fortran 90 modules using SGTOs
  !> \author Bin Gao
  !> \date 2012-03-20
  !> \param io_log is the IO unit of log file
  !> \return test_failed indicates if the test is failed
  subroutine test_f90mod_sgto_carmom(io_log, test_failed)
    use xkind
...
#include "water_f90mod_sgto_carmom.h"
    ...
    integer num_sgto_bra, num_sgto_ket  !number of Cartesian Gaussians of bra and ket centers
    ...
    test_failed = .false.
    call html_log_text("Tests Cartesian multipole integrals of water molecule "// &
                       "using cc-pV6Z Cartesian GTOs ...", io_log)
    ! initializes the information of Cartesian multipole integrals
              ...
              do isgto = 1, num_sgto_bra
                ...
                if (different) then
                  ...
                  call html_log_real_number(                                  &
                         log_text="Referenced Cartesian multipole integral:", &
    ...
    return
  end subroutine test_f90mod_sgto_carmom
