program test
  ...
  open(60,file='raddfq90.inp_8_4_2',status='old',form='formatted',access='sequential',iostat=ier)
  if(ier /= 0)then
    write(6,*) 'test: ERROR while creating raddfq90.inp_8_4_2 file'
    stop
  endif
  ...
  call compare_files(60,'raddfq90.out','raddfq90.out_8_4_2_ref',1.0d-15)
