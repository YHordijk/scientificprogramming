...
#
# Copyright (C) 2004-2005 Sandino Flores Moreno, Christoph Jacob
...
class SimpleGladeDialog(SimpleGladeApp) :

	def __init__(self, glade_filename, main_widget_name=None, domain=None, parent=None):
		SimpleGladeApp.__init__ (self, glade_filename, main_widget_name, domain)
	...
	def destroy (self) :
		return self.main_widget.destroy ()
